...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Run SQLite query and print formatted result")
    parser.add_argument("db", help="Path to .db file")
    parser.add_argument("sql", help="SQL query to run (wrap in quotes)")
    parser.add_argument("-n", "--limit", type=int, default=5, help="Preview rows to show")
